                        ...
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li><a className="dropdown-item" href="/">Replace words</a></li>
                                    <li><a className="dropdown-item" href="/">Convert to words</a></li>
                                    <li><a className="dropdown-item" href="/">Word counter</a></li>
                                </ul>
                            </li>
